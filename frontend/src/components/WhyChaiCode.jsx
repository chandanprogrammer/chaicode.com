    ...
    <div className="px-6 md:px-16 lg:px-16 xl:px-18 2xl:px-55 flex flex-col justify-center items-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 w-full mt-8 gap-6">
        <div className="h-full flex flex-col gap-4 items-center justify-between">
          <div className="bg-gray-900/90 p-6 rounded-2xl shadow-lg border border-orange-100/25 hover:shadow-xl transform hover:scale-105 transition-all duration-300 ease-in-out text-center cursor-pointer">
            <h3 className="text-[20px] font-semibold text-orange-300/70 mb-4 tracking-wide">
              Comprehensive Curriculum
            </h3>
            <p className="text-[14px] tracking-wide text-gray-400/70">
        ...
        <div className="flex items-center justify-between">
          <div className="h-full bg-[#101426] p-4 rounded-2xl shadow-lg border border-orange-100/25 hover:shadow-xl transform hover:scale-105 transition-all duration-300 ease-in-out text-center cursor-pointer flex flex-col items-center justify-center">
            <img src="./images/hitesh.png" alt="" />
            <h2 className="text-3xl font-semibold text-cyan-300/80 my-4">
              Hitesh Choudhary
            </h2>
            <p className="text-[15px] text-gray-400/70">
            ...
            <h3 className="text-2xl font-semibold text-cyan-300/70 my-3">
              Approach
            </h3>
            <p className="text-base text-gray-300/60">
